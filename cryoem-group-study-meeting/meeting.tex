...
\begin{enumerate}
	\item Understand when tilting is needed and why.
	\item Understand how tilting physically works.
	\item Understand how to optimize tilting.
	\item Understand how to mathematical treat tilted data.
\end{enumerate}
\textendash{Pre-reading}
\begin{enumerate}
	...
	\item Baldwin, P. R., \& Lyumkis, D. (2020). Non-uniformity of projection distributions attenuates resolution in Cryo-EM. Progress in Biophysics and Molecular Biology, 150, 160-183. http://doi.org/10.1016/j.pbiomolbio.2019.09.002
	\end{enumerate}
\textendash {Questions}
\begin{enumerate}
