...
Th 23 Dec 2021& \tiny{9 AM PST} & blur/sharpen & No meeting  \\ 
 \hline
 Th 13 Jan 2022 & \tiny{9 AM PST} & blur/sharpen & \tiny{GNC, 6 Model building and validation. \newline 6.5 How algorithms from crystallography are helping electron cryo-microscopy} \\ 
  \hline
 Th 27 Jan 2022 & \tiny{9 AM PST} & \tiny{comp. meth. dev.} & \tiny{Journal Club. Guest: Qinwen (Wendy) Huang} \\ 
[1ex]  
 \hline
\end{longtable}
\end{center}
...
\subsection{16 Dec 2021 - blur/sharpen - Christmas Party}

\textendash {Pre-reading}
\href{https://docs.google.com/document/d/1GQ3-XXjJ2t9jIx9FNJQqJCGFaEdaIFP5SIwbdl3oXoo/edit?usp=sharing}{Twas the Night Before Christmas, in a Cryo-EM Lab}
