...
Th 7 Jan 2021 & \tiny{9 AM PST} & sharpen & convolution, sampling, Nyquist   \\ 
 \hline
Th 17 Jan 2020 & \tiny{9 AM PST} & blur & phase-contrast in the EM   \\ 
 \hline
Th 28 Jan 2021 & \tiny{9 AM PST} & sharpen & phase-contrast in the EM   \\ 
 \hline
Th 4 Feb 2021 & \tiny{9 AM PST} & blur & 2D Expectation-maximization   \\ 
 \hline
Th 11 Feb 2021 & \tiny{9 AM PST} & sharpen & 2D Expectation-maximization   \\ 
 \hline
Th 18 Feb 2021 & \tiny{9 AM PST} & blur &  image formation (forward model)   \\ 
 \hline
Th 25 Feb 2021 & \tiny{9 AM PST} & sharpen & image formation (forward model), multislice   \\ 
% \hline
%Th 4 Mar 2021 & \tiny{9 AM PST} & blur & cryoDRGN (variational autoencoders) with Ellen Zhong  \\ 
% \hline
%Th 11 Mar 2021 & \tiny{9 AM PST} & sharpen & cryoDRGN (variational autoencoders) with Ellen Zhong  \\ 
 \hline
 Mar 2021 & \tiny{9 AM PST} & ... & Wah Chiu et al, lectures, ...  \\ [1ex] 
 \hline
 ... 2021 ... & ... &  ... & ...  \\ 
 \hline
\end{tabular}
...
\begin{itemize}
	...
	\item when you convolve with a {\it broad/wide} gaussian function, what is happening in Fourier space? How does this relate to Fourier filtering? Hint, use the convolution theorem.
\end{itemize}
...
%	\item Zhong, E. D., Bepler, T., Davis, J. H., \& Berger, B. (2019). Reconstructing continuous distributions of 3D protein structure from cryo-EM images. ICLR 2020, 1-20.
...
%%\end{itemize}
%
%\subsection{11 March 2021 - Sharpen}
%\textendash{Pre-reading}
%\begin{itemize}
%	\item \href{https://www.siarez.com/projects/variational-autoencoder}{Variational autoencoder interactive demos with deeplearn.js}
%	\begin{itemize}
