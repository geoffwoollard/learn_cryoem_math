...
\textendash {Questions}
\begin{enumerate}
	\item 2019, II. METHODS. A.: Overall model: Consider Eq. 1. What types of conformational heterogenity does this model capture?
	\item 2019, II.A.: What is the form of the matrix-normal distribution, and how do the covariance matrices ${\bf U}, {\bf V}$ govern this distribution?
	\item 2019, II. B. Bayesian posterior: Where did the covariance matrix ${\bf V}$ go?
	\item 2019, II. C. Prior for the mean structure: What do you think of the prior of ${\bf M}$? Would it make sense to put in more knowledge about how proteins are folded polymer-chains of covalently bonded atoms?
	\item 2019, II. D. Prior over the rotation: Why do Eqs. 7-9 result in a uniform rotation over the sphere? How can we define a measure of uniformity on SO(3)?
	\item 2019, II. E. Prior over the translation: Consider Eq. 11. Some alignment algorithms assume that structures share a centre of mass, and first translate to a shared centre of mass before optimizing over rotation. In what sort of scenarios would having a probabilistic model for translation help alignment? What do you think of the magnitude of covariance in Eq. 11?
	\item 2019, II. F. Prior over U: How exactly is ${\bf U}$ sampled? Which elements are dependent and which independent?
	\item 2019, II. G. Likelihood: Why does "the matrix-normal likelihood of THESEUS [reduce] to a product of univariate Student?s t-distributions."
	\item 2019, II.G.: Unpack the right hand side of Eq. 13, so that you understand each term and could in principle code it up.
	\item 2019, II. I. Initialization: The authors choose to initialize ${\bf u} = (0.9, 0.1, 0.9)$. Why is this near the identity matrix (ie., no rotation)? Would other choices be suitable?
	\item 2019, II. J. Maximum a-posteriori optimization: How exactly does Pyro perform MAP? Look up the documentation to Pyro?s AutoDelta guide.
