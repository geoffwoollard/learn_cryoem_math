...
Date & Time  & Topic \\ [0.5ex] 
 \hline\hline
Fri 21 Jan 2022 & \tiny{9 AM PST}  & Mathy cryoem paper: VESPER (Han et al., 2021) \\ 
  \hline
...
Fri 4 Feb 2022 & \tiny{9 AM PST}  & Rotations - encoding of S0(3) \\ 
 \hline
Fri 11 Feb 2022 & \tiny{9 AM PST}  & \tiny{Mathy cryoem paper: Transformations in SPARX and EMAN2 (Baldwin \& Penczek, 2007)}\\ 
 \hline
Fri 18 Feb 2022 & \tiny{9 AM PST}  &  no meeting \\ 
 \hline
Fri 25 Feb 2022 & \tiny{9 AM PST}  &  Rotating Averaging (Hartley et al., 2013)\\ 
 \hline
Fri 4 Mar 2022 & \tiny{9 AM PST}  & \tiny{Mathy cryoem paper: End-to-end orientation estimation from 2D cryo-EM images (Lian et al., 2022)} \\ 
 \hline
Fri 11 Mar 2022 & \tiny{9 AM PST}  & \tiny{Guest: Lys Sanz Moreta - Deep Probabilistic Programming and 3D Protein Structure (Moreta et al, 2019; Moreta et al 2020)} \\ 
 \hline
Fri 18 Mar 2022 & \tiny{9 AM PST}  & CryoAI - Part I, overview \\ 
 \hline
Fri 25 Mar 2022 & \tiny{9 AM PST}  & CryoAI - Part II, supplementary material \\ 
 \hline
 Fri 1 April 2022 & \tiny{9 AM PST}  &  \tiny{Guest: Andrew Hanson - Discovering Quaternion Applications}\\ 
\hline
Fri 8 April 2022 & \tiny{9 AM PST}  & \tiny{Mathy cryoem paper: Cryofold (Zhong et al., 2021)} \\ 
\hline
Fri 29 April 2022 & \tiny{9 AM PST}  &  \tiny{Mathy cryoem paper: Molecular Prior - Wilson Statistics (Gilles \& Singer, 2022)} \\ 
\hline
Fri 13 May 2022 & \tiny{9 AM PST}  &  \tiny{Mathy cryoem paper: Molecular Prior - Wilson Statistics (Gilles \& Singer, 2022) II} \\ 
\hline
Fri 27 May 2022 & \tiny{9 AM PST}  &  \tiny{Guests: Ngan Nguyen and Feng Liang, Differentiable Electron Microscopy Simulation (Ngan et al. 2022)} \\ 
\hline
Fri 3 Jun 2022 & \tiny{9 AM PST}  & Stochastic gradients (Schulman et al., 2015) \\ 
\hline
Fri 10 Jun 2022 & \tiny{9 AM PST}  & \tiny{Mathy cryoem papers: ManifoldEM} \\ 
\hline
Fri 17 Jun 2022 & \tiny{9 AM PST}  & \tiny{Mathy cryo-EM paper: Cooling on Ensembles (Bock and Grubmüller)} \\ 
\hline
Fri 8 July 2022 & \tiny{9 AM PST}  & \tiny{Mathy cryo-EM paper: Radiation damage to organic and inorganic specimens in the TEM (Egerton, 2019)} \\ 
\hline
\end{longtable}
\end{center}
...
Feel free to share this document and direct people to sign up at \url{https://forms.gle/BUeUW14vV4pyQbDDA} so I have the emails in one place. Online meeting links are emailed to those on this list. {\bf Please join the Slack group \url{https://cryoemstudygroup.slack.com/} and ask questions there, rather than emailing me.} Here is a link to join \url{https://join.slack.com/t/cryoemstudygroup/shared_invite/zt-171mmkqdd-KORjSqcss~A6HNUbOtCpbQ}. If the link is expired, please remind me to update it.
...
\subsection{8 July 2022 - Mathy cryo-EM paper: Radiation damage to organic and inorganic specimens in the TEM (Egerton, 2019)}
\textendash{Pre-reading}
\begin{enumerate}
	\item Egerton, R. F. (2019). Radiation damage to organic and inorganic specimens in the TEM. Micron, 119(November 2018), 72--87. http://doi.org/10.1016/j.micron.2019.01.005
	\end{enumerate}
%\textendash{Questions}
%\begin{itemize}
%	\item
...
\pagebreak
%\subsection{1 April 2022 - CryoAI - Part III, assorted references}
%\textendash{Pre-reading}
%\begin{enumerate}
%	\item Levy, A., Poitevin, F., Martel, J., Nashed, Y., Peck, A., Miolane, N., Ratner, D., Dunne, M., \& Wetzstein, G. (2022). CryoAI: Amortized Inference of Poses for Ab Initio Reconstruction of 3D Molecular Volumes from Real Cryo-EM Images. \url{http://doi.org/10.48550/arXiv.2203.08138}
%	\end{enumerate}

	

\subsection{Summer 2022? - Guest: Nina Miolane.}
\textendash{Pre-reading}
\begin{enumerate}
	\item Donnat, C., Levy, A., Poitevin, F., \& Miolane, N. (2022). Deep Generative Modeling for Volume Reconstruction in Cryo-Electron Microscopy, 1-26.
\end{enumerate}
%\textendash {Questions}
%\begin{enumerate}
%	\item 
...
\subsection{Summer 2022? - Guest: Roy Lederman.}
\textendash{Pre-reading}
\begin{enumerate}
...
\subsection{Fall 2022? - Guest: David Silva. MD simulations and 2D cryo-EM measurements}
%\textendash{Pre-reading}
%\begin{enumerate}
%	\item 
%\end{enumerate}
...
\subsection{Summer 2022? - Guest: Ellen Zhong. CryoDRGN2}
\textendash{Pre-reading}
\begin{enumerate}
...
\textendash {Pre-reading}
\begin{enumerate}
	\item (2019). On the continuity of rotation representations in neural networks. \url{http://doi.org/10.1109/CVPR.2019.00589}
...
\textendash {Pre-reading}
\begin{enumerate}
	\item Masoumzadeh, A., \& Brubaker, M. (2020). HydraPicker: Fully automated particle picking in cryo-em by utilizing dataset bias in single shot detection. 30th British Machine Vision Conference 2019, BMVC 2019, (September).
	\item Zehni, M., \& Zhao, Z. (2021). UVTOMO-GAN: An adversarial learning based approach for unknown view x-ray tomographic reconstruction. Proceedings - International Symposium on Biomedical Imaging, 2021-April, 1812--1816. \url{http://doi.org/10.1109/ISBI48211.2021.9433970}
...
\textendash {Pre-reading}
\begin{enumerate}
	\item Nguyen, N., Liang, F., Engel, D., Bohak, C., Wonka, P., Ropinski, T., \& Viola, I. (2022). Differentiable Electron Microscopy Simulation: Methods and Applications for Visualization, (1), 1--22.
	...
	\item Fanelli, D., \& {\"O}ktem, O. (2008). Electron tomography: A short overview with an emphasis on the absorption potential model for the forward problem. Inverse Problems, 24(1). \url{http://doi.org/10.1088/0266-5611/24/1/013001}
...
\textendash {Questions}
\begin{enumerate}
	\item {\bf See accompanying notebook I made} \url{https://github.com/geoffwoollard/learn_cryoem_math/blob/master/nb/rotation_averaging.ipynb}
	...
	\item 4.1.5: Table 2 Relationship between the different metrics on SO(3): Code up the various metrics ($d_{chord}, d_{quat}$) and numerically verify these relationships on some (arbitrary) rotations
	...
	\item 5.3: Code up Algorithm 1 for several rotations. How do you do the $\log$ and $\exp$ in step 3 and 7? Does your mean seem "in the middle"?
...
\subsection{4 March 2022 - End-to-end orientation estimation from 2D cryo-EM images}
\textendash{Pre-reading}
\begin{itemize}
	\item Lian, R., Huang, B., Wang, L., Liu, Q., Lin, Y., \& Ling, H. (2022). End-to-end orientation estimation from 2D cryo-EM images. Acta Crystallographica Section D Structural Biology, 78(2), 174?186. http://doi.org/10.1107/s2059798321011761
\end{itemize}
\textendash {Questions}
\begin{enumerate}
	\item 1. Introduction: Discuss the problem setup in Figure 1. What are the inputs and output of their method? What sort of specimens (flexibility, symmetry, etc) would it be suitable for?
	\item 2.4 Network architecture: Do you understand the network architecture? Draw a schematic (in more details than Figure 2) of the architecture and point out the "256 feature maps with spatial dimensions 16 x 16" and "2048 feature maps with spatial dimensions 4x4".
	\item 2.5. Loss functions: engage with this claim: "A straightforward loss function is the L1/L2 distance between the predicted normalized quaternion and the ground truth". Consider the distances for rotations defined in Hartley et al (see past meeting on 24 Feb 2021, \ref{meeting:2022_0224})
	\item 2.5: What is the connection between Eqs 11 and 12? Consider the Taylor expansions of $\cos$ and $\arccos$
	\item 2.5: The authors cite {\it Manhardt et al., 2019} in support of the claim "Naively regressing the annotated orientations often ends up with predicting an orientation that is closest to all results in the symmetry group". Look up this reference, and learn how it supports their claim.
	\item 2.6. Data sets: Given the datasets they used to demonstrate the feasibility of their method, in what scenarios could the method be applied?
	\item 2.7: How does the differentiable projection process enter into their method?
	\item 2.8: How is the RMSE in Eq 16 different from the reprojection loss in Eq. 13 and 14?
	\item 3.1 Orientation estimation from synthetic cryo-EM images: Consider Figures 3 and 4. What are the main take-homes? 
	\item 3.1: How does the surrounding area (nearby particles) in Figure 4d (real experimental data) affect the optimization, given the formulation of the RMSE and loss?
	\item 3.3. Cross-validation tests for w: Study Figures 6 and 7. What story do they tell?
	\item 3.4. How is SNR defined here (cf. method section on cryoSPARC)? 
	\item: 3.4: What is the influence of different noise levels? How much is too much noise? Is the noise in Figures 8 and 9 realistic to empirical data? How close is the sim-to-real gap here?
	\item 3.5. Comparison of different representations of 3D orientations: why do you think quaternions performed better than axis-angle?
	\item 3.6. 3D reconstruction using network estimation: What is your impression of the visual results shown in Figure 11a-d?
	\item 4.3. Evaluation metric and reconstruction quality: How could we "modify the training objective by adding another loss term based on FSC"?
	\item 4.4. Handling real cryo-EM images: how could we "efficiently process larger network inputs without significantly increasing the computational cost"?
\end{enumerate}

\subsection{11 March 2022 - Guest: Lys Sanz Moreta}
\textendash{Pre-reading}
\begin{enumerate}
	\item Moreta, L. S., Al-Sibahi, A. S., Theobald, D., Bullock, W., Rommes, B. N., Manoukian, A., \& Hamelryck, T. (2019). A Probabilistic Programming Approach to Protein Structure Superposition. 2019 IEEE Conference on Computational Intelligence in Bioinformatics and Computational Biology, CIBCB 2019. \url{http://doi.org/10.1109/CIBCB.2019.8791469}
	\item Moreta, L. S., Al-Sibahi, A. S., \& Hamelryck, T. (2020). Bayesian protein superposition using Hamiltonian Monte Carlo. Proceedings - IEEE 20th International Conference on Bioinformatics and Bioengineering, BIBE 2020, 1, 1?11. \url{http://doi.org/10.1109/BIBE50027.2020.00009}
\end{enumerate}
\textendash {Questions}
\begin{itemize}
	\item Moreta et al, 2019
	\begin{enumerate}
		\item II. METHODS. A.: Overall model: Consider Eq. 1. What types of conformational heterogenity does this model capture?
		\item II.A.: What is the form of the matrix-normal distribution, and how do the covariance matrices ${\bf U}, {\bf V}$ govern this distribution?
		\item II. B. Bayesian posterior: Where did the covariance matrix ${\bf V}$ go?
		\item II. C. Prior for the mean structure: What do you think of the prior of ${\bf M}$? Would it make sense to put in more knowledge about how proteins are folded polymer-chains of covalently bonded atoms?
		\item II. D. Prior over the rotation: Why do Eqs. 7-9 result in a uniform rotation over the sphere? How can we define a measure of uniformity on SO(3)?
		\item II. E. Prior over the translation: Consider Eq. 11. Some alignment algorithms assume that structures share a centre of mass, and first translate to a shared centre of mass before optimizing over rotation. In what sort of scenarios would having a probabilistic model for translation help alignment? What do you think of the magnitude of covariance in Eq. 11?
		\item II. F. Prior over U: How exactly is ${\bf U}$ sampled? Which elements are dependent and which independent?
		\item II. G. Likelihood: Why does "the matrix-normal likelihood of THESEUS [reduce] to a product of univariate Student?s t-distributions."
		\item II.G.: Unpack the right hand side of Eq. 13, so that you understand each term and could in principle code it up.
		\item II. I. Initialization: The authors choose to initialize ${\bf u} = (0.9, 0.1, 0.9)$. Why is this near the identity matrix (ie., no rotation)? Would other choices be suitable?
		\item II. J. Maximum a-posteriori optimization: How exactly does Pyro perform MAP? Look up the documentation to Pyro's AutoDelta guide.
		\item III. MATERIALS. Proteins: What do you think of the choice of an NMR ensemble? Does it match their modelling choices?
		\item IV. RESULTS. Consider Table I. The "Length (Amino Acids)" are variable. How does the algorithm handle this?
		\item IV. Consider Figure 2. Are you satisfied with the results?
	\end{enumerate}
	\item Moreta et al, 2020
	\begin{enumerate}
		\item What does The No-U-Turn Sampler (NUTS) add to Hamiltonian Monte Carlo (HMC)?
	\end{enumerate}
\end{itemize}

\textendash{Meeting Recording} \\
{\tiny \url{https://ubc.zoom.us/rec/share/IhUJnNpL-n-XCt8OMOB5a1b3XiNgJUBEv7oQAnVqEVXWa79yubR_DG7c3rAHCnNk.1Xul52lwhvisRzw0}} \\
Access Passcode: \texttt{ujd\&kq5\%}

\subsection{18 March 2022 - CryoAI - Part I, overview}
\textendash{Pre-reading}
\begin{enumerate}
	\item Levy, A., Poitevin, F., Martel, J., Nashed, Y., Peck, A., Miolane, N., Ratner, D., Dunne, M., \& Wetzstein, G. (2022). CryoAI: Amortized Inference of Poses for Ab Initio Reconstruction of 3D Molecular Volumes from Real Cryo-EM Images. \url{http://doi.org/10.48550/arXiv.2203.08138}
	\end{enumerate}

\subsection{25 March 2022 - CryoAI - Part II, supplementary material}
\textendash{Pre-reading}
\begin{enumerate}
	\item Levy, A., Poitevin, F., Martel, J., Nashed, Y., Peck, A., Miolane, N., Ratner, D., Dunne, M., \& Wetzstein, G. (2022). CryoAI: Amortized Inference of Poses for Ab Initio Reconstruction of 3D Molecular Volumes from Real Cryo-EM Images. \url{http://doi.org/10.48550/arXiv.2203.08138}
	\end{enumerate}
\textendash {Questions}
\begin{enumerate}
	\item A. Experimental Details. How are the simulated datasets be different from empirical data? How could simulated datasets be more challenging and narrow the sim to real gap?
	\item C.1 Electrostatic Potentials in Fourier Space: Why does the radial average of $|\hat V({\bf k}))|$ differ over only 2 orders of magnitude, while the central slice differs over 5, that is, 1000 fold more?
	\item D.1 Handedness Ambiguity in cryo-EM: Prove $F R_i = \tilde R_i F$. Note that left multiplying by a diagonal matrix (here $F$) is a row multiplication, and right multiplying is a column multiplication. Also note that $\cos(\theta + \pi) = -\cos(\theta)$ and $\sin(\theta + \pi) = -\sin(\theta)$.
	\item D.1: Follow the derivation, line by line.
	\item D.2 Spurious Planar Symmetries and Symmetrized Loss: What would the loss / energy landscape look like for higher symmetries, e.g. $C_n, D_n; \  n \in \{2, 3, ..., 8, ....\}$?
	\item F.1 Full Evaluation of Poses: Consider Figure S8 and discuss the use cases of cryoAI. How do you think practitioners will use amortized inference in practice? Consider the use cases of {\it ab initio} versus iterative refinement.
\end{enumerate}

\subsection{1 April 2022 - Guest: Andrew Hanson. Discovering Quaternion Applications}
\textendash{Reference Material}
\begin{enumerate}
	\item Hanson, A. J. (2020). The quaternion-based spatial-coordinate and orientation-frame alignment problems. Acta Crystallographica Section A: Foundations and Advances, 76, 432?457. \url{http://doi.org/10.1107/S2053273320002648}
	\item Hanson, Andrew, J. (2006). Visualizing Quaternions. \url{http://doi.org/0-12-088400-3}
\end{enumerate}

\textendash {Questions}
\begin{enumerate}
	\item Figure 2: What parameters are learned and what are fixed during training?
	\item Eq 3: Unpack the equation -- what do all the terms refer to?
	\item 4.2 Heterogeneous reconstruction: compare and contrast Cryofold with other methods for heterogeneous reconstruction.
	\item 4.3 Local minima: "A major shortcoming of this atomic reconstruction approach is the existence of many local minima of the loss function that do not approximate the true atomic coordinates." What might a local minima look like and why exactly do they exist?
	\item 5. Results: Architecture and training: What might you want to change/investigate about training?
	\item Are you surprised at the results presented in "5.1 Homogeneous reconstruction", "5.2 Heterogeneous reconstruction", Figures 3-5? Why or why not? What is the main story?
	\item 6 Discussion: What prior beliefs do you have of you sample, and how strongly are these held? 
	\item 6 Discussion: How do you validate these methods?
\end{enumerate}

\subsection{8 April 2022 - Cryofold}
\textendash{Pre-reading}
\begin{enumerate}
	\item Zhong, E. D., Lerer, A., Davis, J. H., \& Berger, B. (2021). Exploring generative atomic models in cryo-EM reconstruction, 1-13.
\end{enumerate}
...
\subsection{29 April 2022 - Molecular Prior - Wilson Statistics}
\textendash{Pre-reading}
\begin{enumerate}
	\item Gilles, M. A., \& Singer, A. (2022). A Molecular Prior Distribution for Bayesian Inference Based on Wilson Statistics, 1?11.
\end{enumerate}

\subsection{13 May 2022 - Molecular Prior - Wilson Statistics II}
\textendash{Pre-reading}
\begin{enumerate}
	\item Gilles, M. A., \& Singer, A. (2022). A Molecular Prior Distribution for Bayesian Inference Based on Wilson Statistics, 1?11.
	\item \url{https://github.com/ma-gilles/wilson_prior}
\end{enumerate}

\subsection{27 May 2022 - Guests: Ngan Nguyen and Feng Liang, Differentiable Electron Microscopy Simulation}
\textendash{Pre-reading}
\begin{enumerate}
	\item Nguyen, N., Liang, F., Engel, D., Bohak, C., Wonka, P., Ropinski, T., \& Viola, I. (2022). Differentiable Electron Microscopy Simulation: Methods and Applications for Visualization, (1), 1--22. \url{http://arxiv.org/abs/2205.04464}
\end{enumerate}

\textendash{Questions}
\begin{enumerate}
	\item In the focal frequency loss (FFL) in Eq. 2, what is the mean over? What is the "normalize" over in $w$ (see paragraph of text below Eq. 2)? Does it have a probabilistic interpretation (i.e. is it the log loss of some distribution)?
	\item In what dose regimes is the parametric form they use of the MTF appropriate? What happens at high dose or low dose? When would the MTF not be circularly symmetric?
	%\item In Algorithm 1, when are the parameters $\Theta_D$ used?
	\item In Algorithm 1, what happens in the step $I_{p_n} \leftarrow\leftarrow I_{p_n}$?
	\item In Algorithm 2, how do they compute line 12: $loss \leftarrow SL(I_n,P, ll)$? 
	\item What do you think are the bottle necks in the performance in Table 2? What could in principle be sped up through parallelization, and what is intrinsically sequential in an advanced simulator?
	\item How exactly does the TEM simulator use the multi-slice method?
\end{enumerate}

\textendash{Meeting Recording} \\
{\tiny \url{https://ubc.zoom.us/rec/share/Nxqm3qRFrowV_bQIjKp9y4qESTcnVziP20hYHYxNBPvQ1zudFCAA7thofsZqsuBi.4ZUgIN3GQEyXf6oh}} \\
Access Passcode: \texttt{jNv5P+qv}

\subsection{3 June 2022 - Stochastic Gradients (Schulman et al., 2015)}
\textendash{Pre-reading}
\begin{enumerate}
	\item Schulman, J., Heess, N., Weber, T., \& Abbeel, P. (2015). Gradient estimation using stochastic computation graphs. Advances in Neural Information Processing Systems, 2015-Janua, 3528?3536. \url{https://arxiv.org/abs/1506.05254}
\end{enumerate}
\textendash{Questions}
\begin{enumerate}
	\item What distributions do not have continuous parameters? If, in a simulator, the parameters come out of a discrete distribution, and then are used as parameters of a continuous distribution, does this violate the assumptions in Schulman et al.?
	\item Consider a simple example of one pixel, going through Poisson and then Gaussian (noise) distributions, where the sampled Poisson random variable is the mean for the Gaussian. What does the estimated gradient look like?
\end{enumerate}

\subsection{10 June 2022 - ManifoldEM}
\textendash{Pre-reading}
\begin{enumerate}
	\item Seitz, E., Acosta-Reyes, F., Maji, S., Schwander, P., \& Frank, J. (2022). Recovery of Conformational Continuum from Single-particle Cryo-EM Images: Optimization of ManifoldEM Informed by Ground Truth. IEEE Transactions on Computational Imaging, PP, 1--1. \url{http://doi.org/10.1109/tci.2022.3174801}
	\item Dashti, Ali and Schwander, Peter and Langlois, Robert and Fung, Russell and Li, Wen and Hosseinizadeh, Ahmad and Liao, Hstau Y. and Pallesen, Jesper and Sharma, Gyanesh and Stupina, Vera A. and Simon, Anne E. and Dinman, Jonathan D. and Frank, Joachim and Ourmazd, Abbas (2014). Trajectories of the ribosome as a Brownian nanomachine. Proceedings of the National Academy of Sciences of the United States of America, 111(49), 17492--17497. \url{http://doi.org/10.1073/pnas.1419276111}
	\item Oliver Oswald. Laplace-Beltrami Operator Intuition, YouTube, 2021. \url{https://youtu.be/ZSh5d03YsEM}
	\item de la Porte, J., Herbst, B. M., Hereman, W., \& van der Walt, S. J. An Introduction to Diffusion Maps. \url{https://inside.mines.edu/~whereman/talks/delaPorte-Herbst-Hereman-vanderWalt-DiffusionMaps-PRASA2008.pdf}
\end{enumerate}
\textendash{Questions}
\begin{enumerate}
	\item How do diffusion maps work (cf. SI section "Manifold Embedding by Diffusion Map" of Dashti et al, PNAS, 2014)?
	\item How does ManifoldEM compare and contrast against other methods to study continuous heterogeneity?
	\item What synthetic data sets were considered in Seitz et al, 2022?
	\item Consider the references in the SI of Dashti et al, PNAS, 2014. What mathematical perspectives / subject areas are they from? Besides cryo-EM, what other applications are there for this type of mathematics?
	\item How should you (biologically) interpret the movies in Dashti et al, PNAS, 2014? {\it These movies consist of a sequence of NLSA reconstructed snapshots, ordered along the minimum-energy path in the energy landscape (Movies S1--S5).} (p. 2, SI). What is the biological meaning of a circular manifold (cf. Figure 3, and discussion in SI section "Patching together information from different orientations").
	\item {\it Reconstruction of the energy landscape for all 320 projection directions requires $\sim$7 d on the same cluster.}, (SI section "Computational expense and scaling" of Dashti et al, PNAS, 2014). How long would practitioners be typically willing to wait for computational results that are highly informative and interpretable?
	\item How is the uncertainly propagated or otherwise accounted for in the ManifoldEM computational pipeline (see SI section "Number of Conformational Classes" of Dashti et al, PNAS, 2014)?
	\item Overall, how interpretable is ManifoldEM to you? What makes it more/less interpretable? How much of its interpretability depends on your understanding of the technique, and how much is intrinsic to the technique itself?
\end{enumerate}

\subsection{10 June 2022 - Mathy cryo-EM paper: Cooling on Ensembles (Bock and Grubmüller)}
\textendash{Pre-reading}
\begin{enumerate}
	\item Bock, L. V., \& Grubmüller, H. (2022). Effects of cryo-EM cooling on structural ensembles. Nature Communications, 13(1). \url{http://doi.org/10.1038/s41467-022-29332-2}
	\end{enumerate}
\textendash{Questions}
\begin{itemize}
	\item Introduction
	\begin{enumerate}
		\item Why is liquid cryo-EM deemed infeasible in the introduction? See: Liao, H.-G., \& Zheng, H. (2016). Liquid Cell Transmission Electron Microscopy. Annual Review of Physical Chemistry, 67(1), 719?747. \url{http://doi.org/10.1146/annurev-physchem-040215-112501}
	\end{enumerate}
	\item Temperature drop during plunge-freezing
	\begin{enumerate}
		\item Figure 1 panel a: What is the take home message of this Figure? Why is there a change between "ensemble before cooling", "ensemble after instance cooling", and "ensemble after slow gradual cooling"?
		\item Figure 1 panel b,c,d: Is there anything unintuitive about the cooling rates? This plots are predicted from theory; how quantitatively accurate would you expect these predictions to be?
		\item Will a sample cool quicker if it is in the middle of a the thin aqueous layer, or near the air-water ($\rightarrow$ cryogen-water) interface?
	\end{enumerate}
	\item Effects of different cooling rates on the ensemble.
	\begin{enumerate}
		\item How closely accurate is the temperature scale in a MD simulation (how closely does it correspond to experimental measurements)? In what ways is the temperature accuracy important for the conclusions of this study?
		\item Figure 2: How quantitatively different is the structural heterogenity in a cryo-EM structure, compared to a room temperature strucure?
		\item Why might we expect the rmsf of atoms in the centre to be smaller than atoms away from the centre? Besides rmsf, are the different measures of heterogeneity that might tell a different story?
		\item What types of heterogeneity does cooling cause? 
		\item Figure S4: How quantitatively large is the difference of backbone and side chain angle heterogeneity before/after cooling? How does this compare with how an atomic model (i.e. cryo-EM structure published on the PDB) might be interpreted?
	\end{enumerate}
